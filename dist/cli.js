...
program
    .command("diff [args...]")
    .description("Show a Git diff of staged and unstaged changes with custom highlighting")
...
program
    .command("commit")
    .description("Generate a Git commit based on the current staged changes and AI-suggested commit message")
    .action(async (o) => {
